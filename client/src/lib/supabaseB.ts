...
// Also note: Vite usually requires VITE_ prefix, but we've added NEXT_PUBLIC_ to envPrefix in vite.config.ts.
const supabaseUrl = import.meta.env?.NEXT_PUBLIC_B_SUPABASE_URL || 'https://ctmvusliphqmoprxgpto.supabase.co';
