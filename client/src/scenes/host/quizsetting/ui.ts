    ...
    static render() {
        ...
        if (!quizSettingsUI) {
            ...
            quizSettingsUI.innerHTML = `
                ...
                <!-- Container: Solid Style as per professionalism request -->
                <div
                    class="w-full max-w-2xl bg-white border-4 border-[#6CC452] border-b-[12px] border-b-[#478D47] shadow-2xl flex flex-col relative rounded-3xl">

                    <!-- Header: rounded-t-3xl -->
                    <div
                    class="bg-[#F1F8E9] p-5 flex items-center justify-between shrink-0 relative rounded-t-[calc(1.5rem-2px)] border-b-2 border-[#6CC452]/10">
                    <!-- Back Button -->
                    <button id="settings-back-btn"
                        class="hidden group flex flex-col items-center">
                        <div
                        class="w-10 h-10 rounded-full bg-white border-2 border-[#6CC452] border-b-4 border-[#478D47] flex items-center justify-center group-hover:brightness-110 active:border-b-0 active:translate-y-1 transition-all text-[#478D47]">
                        <span class="material-symbols-outlined font-bold">arrow_back</span>
                        </div>
                        <span
                        class="text-[10px] font-bold uppercase tracking-widest hidden md:block text-[#478D47] mt-1">Back</span>
                    </button>

                    <div class="flex-1 flex max-w-full justify-center items-center px-2 md:px-4 relative group">
                        <h2 id="settings-quiz-title"
                            class="text-center text-lg md:text-2xl font-bold text-[#478D47] uppercase tracking-widest font-['Retro_Gaming'] leading-snug md:leading-relaxed break-words line-clamp-2 transition-all duration-300">
                            Quiz Title
                        </h2>
                    </div>
                    </div>
                    ...
                    <div class="p-6 space-y-6 overflow-visible">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 relative z-30">
                            ...
                            <div class="space-y-2 relative z-[60]">
                                <label class="flex items-center gap-2 text-[#478D47] text-[10px] font-bold uppercase tracking-widest font-['Retro_Gaming']">
                                    <span class="material-symbols-outlined text-sm">numbers</span> Jumlah Soal
                                </label>
                                <div class="relative w-full">
                                    <button id="settings-question-trigger" class="w-full h-12 bg-[#F1F8E9] border-2 border-[#6CC452]/30 border-b-4 border-[#478D47]/30 rounded-xl flex items-center justify-between px-4 text-[#478D47] font-bold hover:border-[#6CC452] transition-all group active:border-b-0 active:translate-y-0.5">
                                    ...
                                    <div id="settings-question-menu" class="hidden absolute top-[calc(100%+8px)] left-0 w-full bg-white border-2 border-[#6CC452] rounded-xl shadow-2xl overflow-hidden transform transition-all duration-200 origin-top z-[60] flex flex-col p-1">
                                        <button class="question-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="5" data-label="5 Soal">5 Soal</button>
                                        <button class="question-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="10" data-label="10 Soal">10 Soal</button>
                                        <button class="question-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="15" data-label="15 Soal">15 Soal</button>
                                        <button class="question-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="20" data-label="20 Soal">20 Soal</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2 relative z-[50]">
                                ...
                                <div class="relative w-full">
                                    <button id="settings-timer-trigger" class="w-full h-12 bg-[#F1F8E9] border-2 border-[#6CC452]/30 border-b-4 border-[#478D47]/30 rounded-xl flex items-center justify-between px-4 text-[#478D47] font-bold hover:border-[#6CC452] transition-all group active:border-b-0 active:translate-y-0.5">
                                    ...
                                    <div id="settings-timer-menu" class="hidden absolute top-[calc(100%+8px)] left-0 w-full bg-white border-2 border-[#6CC452] rounded-xl shadow-2xl overflow-hidden transform transition-all duration-200 origin-top z-[60] flex flex-col p-1">
                                        <button class="timer-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="300" data-label="5 Menit">5 Menit</button>
                                        <button class="timer-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="600" data-label="10 Menit">10 Menit</button>
                                        <button class="timer-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="900" data-label="15 Menit">15 Menit</button>
                                        <button class="timer-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="1200" data-label="20 Menit">20 Menit</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2 relative z-[40]">
                                ...
                                <div class="relative w-full">
                                    <button id="settings-difficulty-trigger" class="w-full h-12 bg-[#F1F8E9] border-2 border-[#6CC452]/30 border-b-4 border-[#478D47]/30 rounded-xl flex items-center justify-between px-4 text-[#478D47] font-bold hover:border-[#6CC452] transition-all group active:border-b-0 active:translate-y-0.5">
                                    ...
                                    <div id="settings-difficulty-menu" class="hidden absolute top-[calc(100%+8px)] left-0 w-full bg-white border-2 border-[#6CC452] rounded-xl shadow-2xl overflow-hidden transform transition-all duration-200 origin-top z-[60] flex flex-col p-1">
                                        <button class="diff-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="mudah" data-label="Mudah">Mudah</button>
                                        <button class="diff-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="sedang" data-label="Sedang">Sedang</button>
                                        <button class="diff-opt w-full text-left px-4 py-3 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-[#478D47]/70 font-bold font-['Space_Grotesk']" data-value="sulit" data-label="Sulit">Sulit</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2 relative z-[30]">
                                ...
                                <div id="sound-toggle-container" class="w-full h-12 flex items-center bg-[#F1F8E9] border-2 border-[#6CC452]/30 border-b-4 border-[#478D47]/30 rounded-xl px-4 justify-between group hover:border-[#6CC452] transition-all cursor-pointer">
                                    <span class="text-[#478D47] font-bold font-['Space_Grotesk'] tracking-wide">Music</span>
                                    <button id="sound-toggle-btn" class="w-12 h-7 bg-white border border-[#6CC452]/20 rounded-full relative transition-colors duration-300 cursor-pointer shadow-inner shrink-0 pointer-events-none">
                                        <div id="sound-toggle-knob" class="absolute top-[2px] left-[2px] w-6 h-6 bg-[#6CC452] rounded-full shadow-md transform transition-transform duration-300"></div>
                                    </button>
                                </div>
                            </div>
                        </div>
