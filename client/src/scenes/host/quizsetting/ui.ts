                                    ...
                                    <div class="space-y-1 md:space-y-2 relative z-[50]">
                                        ...
                                        <div class="relative w-full">
                                            ...
                                            <div id="settings-timer-menu" class="hidden absolute top-[calc(100%+4px)] left-0 w-full bg-white border-2 border-[#6CC452] rounded-xl shadow-2xl overflow-hidden transform transition-all duration-200 origin-top z-[60] flex flex-col p-1">
                                                <button class="timer-opt w-full ${i18n.getLanguage() === 'ar' ? 'text-right' : 'text-left'} px-4 py-2 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-xs font-bold font-['Space_Grotesk'] text-[#478D47]" data-value="300" data-label="${i18n.t('quiz_setting.m_5')}">${i18n.t('quiz_setting.m_5')}</button>
                                    ...
                                    <div class="space-y-1 md:space-y-2 relative z-[40]">
                                        ...
                                        <div class="relative w-full">
                                            ...
                                            <div id="settings-difficulty-menu" class="hidden absolute top-[calc(100%+4px)] left-0 w-full bg-white border-2 border-[#6CC452] rounded-xl shadow-2xl overflow-hidden transform transition-all duration-200 origin-top z-[60] flex flex-col p-1">
                                                <button class="diff-opt w-full ${i18n.getLanguage() === 'ar' ? 'text-right' : 'text-left'} px-4 py-2 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-xs font-bold font-['Space_Grotesk'] text-[#478D47]" data-value="mudah" data-label="${i18n.t('quiz_setting.diff_easy')}">${i18n.t('quiz_setting.diff_easy')}</button>
                                                <button class="diff-opt w-full ${i18n.getLanguage() === 'ar' ? 'text-right' : 'text-left'} px-4 py-2 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-xs font-bold font-['Space_Grotesk'] text-[#478D47]" data-value="sedang" data-label="${i18n.t('quiz_setting.diff_medium')}">${i18n.t('quiz_setting.diff_medium')}</button>
                                                <button class="diff-opt w-full ${i18n.getLanguage() === 'ar' ? 'text-right' : 'text-left'} px-4 py-2 hover:bg-[#F1F8E9] hover:text-[#478D47] rounded-lg transition-colors text-xs font-bold font-['Space_Grotesk'] text-[#478D47]" data-value="sulit" data-label="${i18n.t('quiz_setting.diff_hard')}">${i18n.t('quiz_setting.diff_hard')}</button>
                                            </div>
                                        </div>
                                    </div>
